                    ...
                    <div className="text-center">
                        <h2 className="text-balance text-8xl font-light uppercase">
                            <span className={`italic font-bold`}><span
                              className={`text-info relative drop-shadow`}>ED</span><span
                              className={`text-warning -ml-4 mr-0`}>NAV</span></span> <span
                          className={`text-4xl font-light uppercase block`}>Success Tracker</span>
                        </h2>
                    </div>
                    <dl
                      className="mt-10 grid grid-cols-1 gap-0.5 overflow-hidden rounded text-center sm:grid-cols-2 lg:grid-cols-4">
