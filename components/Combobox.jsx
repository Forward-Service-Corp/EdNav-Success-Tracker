...
import { ComboboxButton, ComboboxInput, ComboboxOption, ComboboxOptions, Label } from '@headlessui/react';
          ...
          <ComboboxOptions
            ...
            {filteredPeople.map((person) => (
              ...
              >
                ...
                <span
                  className="absolute inset-y-0 right-0 hidden items-center pr-4 text-indigo-600 group-data-[focus]:text-white group-data-[selected]:flex">
